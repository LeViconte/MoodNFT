...
function testConvertSVGToURI() public view {
    ...
    // Encode the SVG manually or using a trusted method in your environment and compare
    string memory expectedURI = deployer.svgToImageURI(svg);  // This line ensures it matches Solidity's behavior
